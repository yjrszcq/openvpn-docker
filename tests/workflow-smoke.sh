...
grep -Fq 'tests/ipam-layout-smoke.sh' "$WORKFLOWS/test.yml"
grep -Fq 'tests/registry-migration-smoke.sh' "$WORKFLOWS/test.yml"
grep -Fq 'tests/client-ip-apply-smoke.sh' "$WORKFLOWS/test.yml"
grep -Fq 'tests/ipam-docs-smoke.sh' "$WORKFLOWS/test.yml"
grep -Fq 'tests/ipam-repair-smoke.sh' "$WORKFLOWS/test.yml"
grep -Fq 'tests/network-migration-smoke.sh' "$WORKFLOWS/test.yml"
