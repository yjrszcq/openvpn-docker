...
var rootCommand = command{
	...
	children: []command{
		...
		group("client", "manage client identities, profiles, and addresses",
			leaf("create", "create a client and its credentials", "ovpn client create NAME [--ipv4|-4 [auto|dynamic|ADDRESS]] [--full-id|-u] [--json|-j]",
				[]string{"IPv4 defaults to auto, the lowest available static address. A bare -4 also means auto.", "JSON output always contains full UUIDs."},
			...
			leaf("reissue", "reissue a client certificate and profile", "ovpn client reissue (NAME|--name|-n NAME|--id|-i ID) [--ipv4|-4 [auto|dynamic|ADDRESS]] [--full-id|-u] [--json|-j]",
