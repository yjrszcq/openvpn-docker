...
var rootCommand = command{
	...
	children: []command{
		...
		group("client", "manage client identities, profiles, and addresses",
			leaf("create", "create a client and its credentials", "ovpn client create NAME [--ipv4|-4 [auto|dynamic|ADDRESS]] [--full-id|-u]",
			...
			leaf("rename", "rename a client without changing its UUID", "ovpn client rename (NAME|--name|-n NAME|--id|-i ID) NEW_NAME [--full-id|-u]",
				[]string{"A positional selector is an exact client name; ID prefixes require --id or -i."},
				"ovpn client rename laptop office-laptop"),
			leaf("revoke", "revoke a client certificate", "ovpn client revoke (NAME|--name|-n NAME|--id|-i ID) [--release-ipv4|-4] [--full-id|-u]",
			...
			leaf("reissue", "reissue a client certificate and profile", "ovpn client reissue (NAME|--name|-n NAME|--id|-i ID) [--ipv4|-4 [auto|dynamic|ADDRESS]] [--full-id|-u]",
			...
			leaf("delete", "delete local client credentials and retain a UUID tombstone", "ovpn client delete (NAME|--name|-n NAME|--id|-i ID) [--yes|-y] [--full-id|-u]",
			...
			group("address", "manage client IPv4 assignment intent",
				leaf("set", "set one active client's IPv4 intent", "ovpn client address set (NAME|--name|-n NAME|--id|-i ID) --ipv4|-4 [auto|dynamic|ADDRESS] [--full-id|-u]",
				...
				leaf("release", "release a revoked client's retained static IPv4", "ovpn client address release (NAME|--name|-n NAME|--id|-i ID) [--full-id|-u]",
